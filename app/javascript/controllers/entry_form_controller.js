...
export default class extends Controller {
  static targets = ["creditTitle", "debitTitle", "amount", "submitBtn"];
  ...
  validate = (event) => {
    ...
    this.#updateView(targetElement, validationResult);
  };
  ...
  #validatesAll = () => {
    ...
    elements.forEach((element) => {
      ...
      this.#updateView(element, validationResult);
    });
  };
  ...
  #updateView = (element, validationResult) => {
    ...
    this.submitBtnTarget.disabled = !this.#isAllValid();
  };
